...
public:
  ...
  ValueIteratorBase();
#ifndef JSON_VALUE_USE_INTERNAL_MAP
	explicit ValueIteratorBase(const std::map<Value::CZString, Value>::iterator &current); // sam
//	explicit ValueIteratorBase(const Value::ObjectValues::iterator &current);             // mark by sam
#else
